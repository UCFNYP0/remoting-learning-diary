...
```{r echo=FALSE, out.width = "60%", fig.align='left', cache=FALSE, fig.cap= "OneNYC2050. Source: [OneNYC 2050](https://onenyc.cityofnewyork.us/strategies/a-livable-climate/)"}
...
```{r echo=FALSE, out.width = "60%", fig.align='left', fig.cap= "Geopackage. Source: [Methodology and Deliverables Report_LONDON_ARTi](https://airdrive-secure.s3-eu-west-1.amazonaws.com/london/dataset/major-summer-heatspots-using-landsat-8-thermal-satellite-data/2021-03-17T17%3A25%3A49/Methodology%20and%20Deliverables%20Report_LONDON_ARTi.pdf?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAJJDIMAIVZJDICKHA%2F20230317%2Feu-west-1%2Fs3%2Faws4_request&X-Amz-Date=20230317T213731Z&X-Amz-Expires=300&X-Amz-Signature=1bbf57ee50c4c58ca33366d8d5d492a894efe46b3d1eecffc2d24b19dff6ca44&X-Amz-SignedHeaders=host)"}
knitr::include_graphics('week4_data/OUTPUT1.png')
```
```{r echo=FALSE, out.width = "60%", fig.align='left', fig.cap= "Geopackage. Source: [Methodology and Deliverables Report_LONDON_ARTi](https://data.london.gov.uk/dataset/major-summer-heatspots-using-landsat-8-thermal-satellite-data)"}
...
Heat exposure was estimated using the urban heat risk index (UHRI), a composite
index of biophysical factors related to urban heat.And the equation is UHRI = [LST (z score) + NDBI (z score)] − NDVI (z score).\
...
```{r echo=FALSE, out.width = "60%", fig.align='left', fig.cap= "UHRI & NDVI. Source: [Social Inequities in Urban Heat and Greenspace: Analyzing Climate Justice in Delhi,India](https://www.mdpi.com/1660-4601/18/9/4800)"}
...
```{r echo=FALSE, out.width = "60%", fig.align='left', fig.cap= "Generalized estimating equation for predicting May UHRI using ward level socio-demographic variables. Source: [Social Inequities in Urban Heat and Greenspace: Analyzing Climate Justice in Delhi,India](https://www.mdpi.com/1660-4601/18/9/4800)"}
